...
#########################
chunk = CHUNK = 1024  # Record in chunks of 1024 samples
...
#            sys.stdout.flush()
            ...
            if re.search(r'\b(exit|quit|thanks|hush|bye)\b', transcript, re.I):
                print('Exiting..')
                break
...
def intro():
    ...
    myAudio2.set_volume(0.5)
    pygame.mixer.Channel(0).play(myAudio2)
    myAudio1.set_volume(0.5)
    pygame.mixer.Channel(1).play(myAudio1)
    time.sleep(17)

    myAudio4.set_volume(0.6)
